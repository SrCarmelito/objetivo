const url = "objetivo.onrender.com/pessoas";
const urlEndereco = "objetivo.onrender.com/enderecos";
...
async function getDadosPorCep(cepBusca) {
    const response = await fetch(`objetivo.onrender.com/enderecos/cep/${cepBusca}`);
